<template>
	<div class="fixed top-0 left-0 z-50 h-screen w-screen bg-[url('/images/gallery4.jpg')] bg-cover bg-center bg-no-repeat md:bg-[50%_25%]" id="splash">
		...
		<div class="flex h-full w-full flex-col items-center justify-center gap-y-16">
			<div class="space-y-6 text-center md:space-y-14 lg:space-y-10">
				<h1 class="font-serif text-xl text-slate-600 dark:text-gray-100 md:text-4xl">Undangan Pernikahan</h1>
				<h2 class="font-body text-4xl text-yellow-800 dark:text-yellow-300/90 md:text-7xl">Rudi & Shella</h2>
				<span class="block font-serif text-slate-600 dark:text-gray-100 md:text-xl">Kepada Yth.</span>
			...
			<p class="absolute bottom-5 max-w-xs text-center text-xs font-semibold text-slate-600 dark:text-gray-100 md:max-w-full">
